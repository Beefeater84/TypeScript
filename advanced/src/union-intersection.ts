...
- Объясните, почему TypeScript не может безопасно "сузить" (narrow) тип объединения, если объект, назначенный ему, содержит свойства всех членов объединения. 
- Каков "неудачный побочный эффект" структурной типизации TypeScript, упомянутый в видео, применительно к объединениям? 
- Как можно изменить тип объединения, чтобы он полностью поддерживал случай, когда объект содержит свойства всех составляющих его типов? 
